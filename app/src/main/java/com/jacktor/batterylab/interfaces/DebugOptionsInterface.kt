...
import com.jacktor.batterylab.databinding.ChangePrefKeyDialogBinding
import com.jacktor.batterylab.databinding.ResetPrefKeyDialogBinding
...
interface DebugOptionsInterface {
    ...
    private fun addSettingCreateDialog(context: Context, pref: SharedPreferences) {
        ...
        val binding = AddPrefKeyDialogBinding.inflate(
        ...
        dialog.apply {
            ...
            setPositiveButton(context.getString(R.string.add)) { _, _ ->
                addSettingCreateDialogPositiveButton(
                    context, pref, binding.addPrefKeyEdit,
        ...
        dialogCreate.setOnShowListener {
            ...
            binding.addPrefKeyEdit.addTextChangedListener(
                addPrefKeyTextChangedListener(
            ...
            binding.addPrefValueEdit.addTextChangedListener(
                addPrefValueTextChangedListener(
    ...
    private fun addSettingCreateDialogPositiveButton(
        context: Context, pref: SharedPreferences,
        ...
        try {
            ...
            when (addPrefType.selectedItemPosition) {
                ...
                0 -> addChangeSetting(
                    pref,
                    addPrefKey.text.toString(),
                    addPrefValue.text.toString()
                )

                1 -> addChangeSetting(
                    pref, addPrefKey.text.toString(),
                ...
                4 -> addChangeSetting(
                    context, pref, addPrefKey.text.toString(),
            ...
            Toast.makeText(
                context, context.getString(
                    R.string.setting_added_successfully,
                    addPrefKey.text.toString()
                ), Toast.LENGTH_LONG
            ).show()
        } catch (e: Exception) {
            ...
            Toast.makeText(
                context, context.getString(
                    R.string.error_adding_settings,
                    addPrefKey.text.toString(), e.message ?: e.toString()
                ), Toast.LENGTH_LONG
            ).show()
        }
    }

    private fun addPrefKeyTextChangedListener(
        addPrefKey: TextInputEditText,
        addPrefValue: TextInputEditText,
        ...
        return object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                addPrefValue.isEnabled =
                    s.isNotEmpty() && !pref.contains(addPrefKey.text.toString())
            }
        }
    }
    ...
    private fun addPrefValueTextChangedListener(
        addPrefValue: TextInputEditText,
    ...
    private fun changeSettingCreateDialog(context: Context, pref: SharedPreferences) {
        ...
        val binding = ChangePrefKeyDialogBinding.inflate(
        ...
        dialogCreate.setOnShowListener {
            ...
            binding.changePrefKeyEdit.addTextChangedListener(
                changePrefKeyTextChangedListener(
                    binding.changePrefValueEdit, pref, prefKeysArray
                )
            )

            binding.changePrefValueEdit.addTextChangedListener(
                changePrefValueTextChangedListener(
    ...
    private fun changeSettingPositiveButton(context: Context, key: String, value: Any) {
        ...
        try {
            ...
            when (key) {
                ...
                NUMBER_OF_CHARGES, NUMBER_OF_FULL_CHARGES -> addChangeSetting(
                    pref, key,
            ...
            Toast.makeText(
                context, context.getString(R.string.success_change_key, key),
                Toast.LENGTH_LONG
            ).show()
        } catch (e: Exception) {
            ...
            Toast.makeText(
                context, context.getString(
                    R.string.error_changing_key, key,
    ...
    private fun changePrefKeyTextChangedListener(
        changePrefValue: TextInputEditText,
        pref: SharedPreferences,
        prefKeysArray: MutableList<String>
    ): TextWatcher {
    ...
    private fun setValueType(
        valueType: String, changePrefValue: TextInputEditText,
        ...
        when (valueType) {
            ...
            "int|long" -> {
                ...
                changePrefValue.filters = arrayOf(
                    InputFilter.LengthFilter(
            ...
            "boolean" -> {
                ...
                changePrefValue.setText(
                    if (pref.all.getValue(key).toString() == "true") "1"
                    else "0"
                )
    ...
    private fun changePrefValueTextChangedListener(
        context: Context, dialogCreate: AlertDialog,
                ...
                dialogCreate.getButton(DialogInterface.BUTTON_POSITIVE).isEnabled = s.isNotEmpty()
                    ...
                    "string" -> {
                        ...
                        when (key) {
                            ...
                            OVERLAY_LOCATION -> s.toString() != pref.getString(
                                key,
                                "${
                            ...
                            TEXT_SIZE -> s.toString() != pref.getString(
                                key, "2"
                            ) && s.toString() in context.resources
    ...
    private fun addChangeSetting(
        pref: SharedPreferences, key: String,
        value: Int
    ) {
    ...
    private fun addChangeSetting(
        context: Context, pref: SharedPreferences, key: String,
        value: Boolean
    ) {
        ...
        } else if (key == ENABLED_DEBUG_OPTIONS && !value) {
    ...
    fun DebugFragment.resetSettingDialog(pref: SharedPreferences) {
        ...
        val binding = ResetPrefKeyDialogBinding.inflate(
            LayoutInflater.from(context), null,
            false
        )
        ...
        dialog.setPositiveButton(getString(R.string.reset)) { _, _ ->
            ...
            when (key) {
                ...
                AUTO_DARK_MODE, DARK_MODE -> ThemeHelper.setTheme(requireContext())
            ...
            Toast.makeText(
                requireContext(), getString(R.string.key_successfully_reset, key),
                Toast.LENGTH_LONG
            ).show()
        }
    ...
    fun DebugFragment.onAddCustomHistory(
        pref: SharedPreferences,
        ...
        val binding = AddCustomHistoryDialogBinding.inflate(
        ...
        dialog.setPositiveButton(requireContext().getString(R.string.add)) { _, _ ->
            ...
            CoroutineScope(Dispatchers.Default).launch {
                ...
                withContext(Dispatchers.Main) {
                    Toast.makeText(
                        requireContext(), "$addHistoryCount",
                        Toast.LENGTH_LONG
                    ).show()
    ...
    private fun addHistoryDialogCreateShowListener(
        context: Context,
